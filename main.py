...
from Nevasa.VentaSimultanea import nevasa_venta_simultanea_parser
...
nevasa_venta_simultanea_folder = f"{nevasa_folder}/VentaSimultanea"
...
nevasa_venta_simultanea_parser(process_date,nevasa_venta_simultanea_folder)